    ...
    <div class="container">
		...
		<div class="panel-heading">
		    <div class="btn-group pull-right">
				<button type='button' class="btn btn-primary" data-toggle="modal" data-target="#myModal"><span class="glyphicon glyphicon-ok" ></span> Nuevo Usuario</button>
			</div>
			<h4><i class='glyphicon glyphicon-hand-right'></i> Buscar Usuarios</h4>
		</div>			
			<div class="panel-body">
			<?php
			include("modelos/registro_usuarios.php");
			include("modelos/editar_usuarios.php");
			include("modelos/cambiar_password.php");
			?>
