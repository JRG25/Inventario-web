	...
	<div class="panel panel-success">
		<div class="panel-heading">
		    <div class="btn-group pull-right">
				<button type='button' class="btn btn-primary" data-toggle="modal" data-target="#nuevoCliente"><span class="glyphicon glyphicon-ok" ></span> Nueva Categoría</button>
			</div>
			<h4><i class='glyphicon glyphicon-hand-right'></i> Buscar Categorías</h4>
		</div>
		<div class="panel-body">

			<?php
				include("modelos/registro_categorias.php");
				include("modelos/editar_categorias.php");
			?>
