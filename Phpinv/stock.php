	...
	<div class="panel panel-success">
		<div class="panel-heading">
		    <div class="btn-group pull-right">
				<button type='button' class="btn btn-primary" data-toggle="modal" data-target="#nuevoProducto"><span class="glyphicon glyphicon-ok" ></span> Agregar</button>
			</div>
			<h4><i class='glyphicon glyphicon-hand-right'></i> Consultas de Busqueda</h4>
		</div>
		<div class="panel-body">
				
			<?php
			include("modelos/registro_productos.php");
